 ...
 * Surge：
[Script]	
彩云天气SVIP = type=http-response,requires-body=1,max-size=0,pattern=https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user),script-path=https://raw.githubusercontent.com/BlueGrave/Surge/master/Scripts/CaiYun.js
 * 
 * Loon：
[Script]	
http-response https?:\/\/biz\.caiyunapp\.com\/(membership_rights|v2\/user),script-path=https://raw.githubusercontent.com/BlueGrave/Surge/master/Scripts/CaiYun.js,requires-body=1, tag=彩云天气SVIP	
 */	
...
const RESULT = {	
  is_vip: true,	
  vip_type: "s",	
  svip_expired_at: 5141603754.4403821354,	
}	
const RESULT_WT = {	
  vip: {	
    enable: true,	
